                ...
                <div class="card-header">
                    <div class="row">
                        <div class="btn-group col-lg-1">
                            <a href="{{ route('gallerycategory.index') }}" class="btn btn-primary btn-flat btn-sm">
                                <i class="fas fa-sync-alt fa-sm"></i> Refresh
                            </a>
                        </div>
                        <div class="col-lg-7">
                            <form action="{{route('gallerycategory.index')}}" class="">
                                <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card-tools float-right">
                                @can('tag-create')
                                    <a href="{{ route('gallerycategory.create') }}" class="btn btn-success btn-sm btn-flat mr-2">
                                        <i class="fa fa-plus"></i> Add Gallery Category</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @can('tag-edit')
                                                <a href="{{ route('gallerycategory.edit', $value->id) }}" title="Edit Tag"
                                                    class="btn btn-success btn-sm btn-flat"><i class="fas fa-edit"></i></a>
                                            @endcan
                                            @can('tag-delete')
                                                {{ Form::open(['method' => 'DELETE', 'route' => ['gallerycategory.destroy', $value->id], 'style' => 'display:inline', 'onsubmit' => 'return confirm("Are you sure you want to delete this Gallery Category?")']) }}
