                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td><div class="btn-group">
                                <a href="{{route('fetchrowinternal',$value->$dbname1)}}" title="view columns of the table" class="btn btn-primary btn-sm btn-flat"><i class="fas fa-eye"></i></a>
                            </div></td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{ $value->$dbname2 }}</td> 
                              <td><div class="btn-group">
                                <a href="{{route('fetchrowexternal',$value->$dbname2)}}" title="view columns of the table" class="btn btn-primary btn-sm btn-flat"><i class="fas fa-eye"></i></a>
                            </div></td>
                            </tr>
                            @endforeach
                        </tbody>
