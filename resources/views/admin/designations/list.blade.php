                ...
                <div class="card-header">
                    <div class="row">
                        <div class="p-1 col-lg-2">
                            <div class="btn-group">
                                <a href="{{ route('designations.index') }}" class="btn btn-primary btn-flat btn-sm">
                    ...
                    @if ($data->count() > 0)
                        <ol class="sortable">
                                        ...
                                        <div class="menu-handle d-flex justify-content-between">
                                            ...
                                            <div class="menu-options btn-group">
                                                ...
                                                @can('designations-edit')
                                                    <a href="{{ route('designations.edit', $item->id) }}" class="btn btn-xs btn-success">
                            ...
                            <div class="form-group mt-4">
                                ...
                                @endcanany
                                <a href="{{ route('designation.resetorder') }}" type="button" class="btn btn-danger btn-sm btn-flat"><i
