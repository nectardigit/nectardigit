            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('env.index') }}" type="button" class="btn btn-tool">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="p-1 col-lg-2">
                            <div class="btn-group">
                                <a href="{{ route('env.index') }}" class="btn btn-primary btn-flat btn-sm">
                                        ...
                                        <div v-show="views[0].active">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <p>
                                                        <a href="javascript:;" v-show="loadButton" class="btn btn-primary"
                                                            @click="loadEnv">
                                                ...
                                                <div class="table-responsive" v-show="!loadButton">
                                                    <table class="table table-striped">
                                                        <tr>
                                                            <th>{{ trans('dotenv-editor::views.overview_table_key') }}
                                                            </th>
                                                            <th>{{ trans('dotenv-editor::views.overview_table_value') }}
                                                            </th>
                                                            <th>{{ trans('dotenv-editor::views.overview_table_options') }}
                                                            </th>
                                                        </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            title="{!! trans('dotenv-editor::views.backup_table_options_restore') !!}"><i
                                                                                class="fas fa-sync"></i>
                                                                        </a>
                                                ...
                                                <div class="modal fade" id="showDetails" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a href="javascript:;"
                                                                    @click="restoreBackup(currentBackup.timestamp)"
                                        ...
                                        <div v-show="views[3].active">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form method="post"
                                                        action="{{ url(config('dotenveditor.route.prefix') . '/upload') }}"
                        ...
                        <script>
                            new Vue({
                                ...
                                data: {
                                    ...
                                    alertmessage: '',
                                    views: [{
                                            name: "{{ trans('dotenv-editor::views.overview') }}",
                                            active: 1
                                        },
                                        {
                                            name: "{{ trans('dotenv-editor::views.addnew') }}",
                                            active: 0
                                        },
                                        {
                                            name: "{{ trans('dotenv-editor::views.backups') }}",
                                            active: 0
                                        },
                                        {
                                            name: "{{ trans('dotenv-editor::views.upload') }}",
                                            active: 0
                                        }
                                    ],
                                    newEntry: {
                                ...
                                methods: {
                                    ...
                                    addNew: function() {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function() {
                                                ...
                                                var msg =
                                                    "{{ trans('dotenv-editor::views.new_entry_added') }}";
                                    ...
                                    updateEntry: function() {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function() {
                                                var msg =
                                                    "{{ trans('dotenv-editor::views.entry_edited') }}";
                                                vm.showAlert("success", msg);
                                        ...
                                        $.ajax({
                                            ...
                                            success: function() {
                                                vm.showAlert('success',
                                                    "{{ trans('dotenv-editor::views.backup_created') }}"
                                                    );
                                            }
                                        })
                                    },
                                    showBackupDetails: function(timestamp, formattedtimestamp) {
                                        ...
                                        var vm = this;
                                        $.getJSON("/{{ $url }}/getdetails/" + timestamp, function(
                                            items) {
                                            vm.details = items;
                                    ...
                                    restoreBackup: function(timestamp) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function() {
                                                ...
                                                vm.showAlert('success',
                                                    '{{ trans('dotenv-editor::views.backup_restored') }}'
                                                    );
                                            }
                                        })
                                    },
                                    deleteEntry: function() {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function() {
                                                var msg =
                                                    "{{ trans('dotenv-editor::views.entry_deleted') }}";
                                                vm.showAlert("success", msg);
                                            }
                                        });
                                    ...
                                    modal: function(entry) {
                                        ...
                                        this.deleteModal.title =
                                            "{{ trans('dotenv-editor::views.delete_entry') }}";
