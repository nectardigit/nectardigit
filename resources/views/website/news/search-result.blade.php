        ...
        <div class="breadcrumbs">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">खोज नतिजा</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="thumb-news">
                            <div class="left-img">
                                <a href="{{ route('newsDetail', $item->slug) }}">
                                    ...
                                    <x-shared-image
                                        newsimage="{{ create_image_url($item->img_url, 'thumbnail') }}"
                                        title="search" />
{{--                                    <img src="{{ create_image_url($item->img_url, 'thumbnail') }}">--}}
                                </a>
