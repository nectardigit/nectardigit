...
class PhotoFeatureNewsController extends Controller
{
    //
    ...
    public function photoFeatureNews(Request $request){
        ...
        $this->news = $this->news->query()->where('isPhotoFeature','1');
